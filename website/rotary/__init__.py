...
def create_app(test_config=None):
    ...
    app.config.from_mapping(
        ...
        MARIADB_HOST=os.environ.get('ROTARY_MARIADB_HOST'),
        MARIADB_USER=os.environ.get('ROTARY_MARIADB_USER'),
        MARIADB_PASS=os.environ.get('ROTARY_MARIADB_PASS'),
        MARIADB_DB=os.environ.get('ROTARY_MARIADB_DB'),
